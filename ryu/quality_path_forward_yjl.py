...
class DelayDetector(simple_switch_13.SimpleSwitch13):
    ...
    def add_flow(self, datapath, priority, match, actions):
        ...
        command = ofp.OFPFC_ADD  # flow entry add
        ...
        if arp_pkt:
            if arp_pkt.opcode == arp.ARP_REQUEST:
                ...
                if arp_dst_ip in self.arp_table:
                    ...
                    out = parser.OFPActionOutput(datapath=datapath, buffer_id=ofproto.OFP_NO_BUFFER, in_port=ofproto.OFP_CONTROLLER, actions=actions, data=ARP_Reply.data)
    ...
    def packet_in_handler(self, ev):
        ...
        # Link Layyer Discovery Protocol
    ...
    def link_delay(self):
        ...
        #print("link :{}".format(self.link_Delay))
