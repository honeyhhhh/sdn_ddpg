...
class Topo(object):
    ...
    def get_graph(self):
        Matrix = np.array(np.ones((14,14))*999999)

        for (s,t) in self.adjacent.keys():
            Matrix[s-1][t-1] = random.randint(1,10)
...
class MyController(app_manager.RyuApp):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.arp_table = {'192.168.0.1':'00:00:00:00:00:01',
                          ...
                          '192.168.0.10':'00:00:00:00:00:0a',
                          '192.168.0.11':'00:00:00:00:00:0b',
                          '192.168.0.12':'00:00:00:00:00:0c',
                          '192.168.0.13':'00:00:00:00:00:0d',
                          '192.168.0.14': '00:00:00:00:00:0e',
        ...
        self.rarp_table = {'00:00:00:00:00:01':'192.168.0.1',
                           ...
                           '00:00:00:00:00:0a':'192.168.0.10',
                           '00:00:00:00:00:0b':'192.168.0.11',
                           '00:00:00:00:00:0c':'192.168.0.12',
                           '00:00:00:00:00:0d':'192.168.0.13',
                           '00:00:00:00:00:0e':'192.168.0.14',
